...
%             %filteredImg(i-6,j-6,k)=(((sum(abs(filteredImageExt(i-6:i+6,j-6:j+6)).^2,'all'))));
%             %reject
%     end
% end
% 
...
for i=10:(width+9)
    for j=10:(height+9)
            ...
            %filteredImg(i-9,j-9,k)=sqrt(((sum(abs(filteredImageExt(i-9:i+9,j-9:j+9)).^2,'all'))));
            %reject
    end
end
end
...
filteredImg15=zeros(width,height,15);
filteredImg15(:,:,1)=filteredImg(:,:,1);
filteredImg15(:,:,2)=((filteredImg(:,:,2)+filteredImg(:,:,6))/2);
filteredImg15(:,:,3)=((filteredImg(:,:,3)+filteredImg(:,:,11))/2);
filteredImg15(:,:,4)=((filteredImg(:,:,4)+filteredImg(:,:,16))/2);
filteredImg15(:,:,5)=((filteredImg(:,:,5)+filteredImg(:,:,21))/2);
filteredImg15(:,:,6)=filteredImg(:,:,7);
filteredImg15(:,:,7)=((filteredImg(:,:,8)+filteredImg(:,:,12))/2);
filteredImg15(:,:,8)=((filteredImg(:,:,9)+filteredImg(:,:,17))/2);
filteredImg15(:,:,9)=((filteredImg(:,:,10)+filteredImg(:,:,22))/2);
filteredImg15(:,:,10)=filteredImg(:,:,13);
filteredImg15(:,:,11)=((filteredImg(:,:,14)+filteredImg(:,:,18))/2);
filteredImg15(:,:,12)=((filteredImg(:,:,15)+filteredImg(:,:,23))/2);
filteredImg15(:,:,13)=filteredImg(:,:,19);
filteredImg15(:,:,14)=((filteredImg(:,:,20)+filteredImg(:,:,24))/2);
filteredImg15(:,:,15)=filteredImg(:,:,25);



kmeansInput=zeros(width*height,15);
...
se = strel('disk',7);
%afterOpening = imopen(kmeansOutput,se);
